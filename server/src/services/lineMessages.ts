...
export const M = {
  ...
  checklistToeic: { zh: 'TOEIC 衝刺', en: 'TOEIC Push', ja: 'TOEIC 対策' },
  checklistPortfolio: { zh: '作品集規劃', en: 'Portfolio Planning', ja: 'ポートフォリオ計画' },
  checklistFrontend: { zh: '前端小知識', en: 'Frontend Notes', ja: 'フロントエンド学習' },
